...
window.onload = () => {
    ...
    const validateField = (field) => {
        field.value.trim() ? field.classList.remove("error") : field.classList.add("error");

        if (elements.nameInput.value.trim() && elements.emailInput.value.trim() && elements.messageInput.value.trim()) {
